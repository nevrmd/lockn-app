...
class StatisticsCalculatorTest {
    ...
    fun `calculateWeeklyStats returns 7 days of stats`() {
        val habit = Habit(id = "1", emoji = "🚀", name = "Test", metricNoun = "units", targetAmount = 10, createdAtDate = LocalDate.parse("2024-01-01"))
    ...
    fun `calculateMonthlyStat calculates correct total and target`() {
        val habit = Habit(id = "1", emoji = "🚀", name = "Test", metricNoun = "units", targetAmount = 2, createdAtDate = LocalDate.parse("2024-01-01"))
        ...
        assertThat(monthlyStat?.monthName).isEqualTo("January")
    }

    @Test
    fun `calculateMonthlyStat with habit created mid-month adjusts target`() {
        val habit = Habit(id = "1", emoji = "🚀", name = "Test", metricNoun = "units", targetAmount = 2, createdAtDate = LocalDate.parse("2024-01-15"))
        val monthStart = LocalDate.parse("2024-01-01")
